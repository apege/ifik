            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                ...
                <div class="clean-card rounded-2xl p-6 flex flex-col justify-between hover:border-orange-300 transition-all group">
                    <div>
                        ...
                        <p class="text-xs text-slate-500 leading-relaxed mb-4">
                            Portal terpadu Dosen Pembimbing, Dosen Penguji, dan Dosen Wali usulan Tugas Akhir mahasiswa.
                        </p>
                    </div>
                    <div class="pt-4 border-t border-slate-100 flex items-center justify-between">
                        <span class="text-[11px] font-medium text-slate-400">
                        ...
                        <a href="<?= site_url('dosen/bimbingan'); ?>" class="px-3.5 py-1.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-200 rounded-xl text-xs font-semibold shadow-xs flex items-center gap-1.5 transition-all">
                            Portal Dosen <i class="bi bi-arrow-right"></i>
                        </a>
                    </div>
                </div>
